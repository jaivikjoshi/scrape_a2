...
#!/usr/bin/env python3
"""
Test script for the enhanced RequestsScraper with Cloudflare bypass capabilities.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("cloudflare_test.log"),
...
def test_cloudflare_bypass():
    """Test the enhanced RequestsScraper with Cloudflare bypass capabilities."""
    logger.info("Testing enhanced RequestsScraper with Cloudflare bypass...")
    
    try:
        # Initialize the scraper
        scraper = RequestsScraper()
        
        # First, preload cookies from the homepage
        logger.info("Preloading cookies from homepage...")
        scraper.preload_cookies("https://filmfreeway.com")
        ...
        if html and len(html) > 1000:
            ...
            logger.error("Failed to get valid content from enhanced RequestsScraper")
            return False
...
def main():
    """Run all tests."""
    logger.info("Starting Cloudflare bypass tests...")
    
    # Test the enhanced RequestsScraper with Cloudflare bypass
    festivals_result = test_cloudflare_bypass()
    ...
    logger.info(f"Cloudflare bypass test: {'PASSED' if festivals_result else 'FAILED'}")
